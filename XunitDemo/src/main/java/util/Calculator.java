...
public class Calculator {
    ...
    public static AtomicInteger atomicResult = new AtomicInteger(0);
    ...
    public static int atoicCount(int x) throws InterruptedException{
        return atomicResult.addAndGet(x);
    }

    public static int leftCount(int x) throws InterruptedException{
        result+=x;
        return result;
    }
